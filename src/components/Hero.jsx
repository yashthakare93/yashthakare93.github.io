    ...
    <section id='home' className="min-h-screen bg-slate-900 text-white font-sans  overflow-hidden cursor-default ">
      ...
      <main className="relative w-full h-screen">
        ...
        >
          ...
          >
            <h2 className="text-lg text-slate-400 mb-2">Hello 👋</h2>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight">
              I'm{" "}
              <span className="bg-gradient-to-r from-cyan-300 via-indigo-400 to-purple-600 bg-clip-text text-transparent">
                Yash Thakare
              </span>
            </h1>

            <h2 className="text-xl md:text-2xl lg:text-3xl font-semibold text-slate-300 mt-4 ">
              PESMCOE Student · Developer · Coder
            </h2>

            <p className="text-base md:text-lg text-slate-400 mt-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              I build beautiful, fast, and user-focused digital experiences using modern web technologies. Let’s create something meaningful together.
            </p>
            ...
            >
              ...
              <a
                href="src\assets\cv\Yash_Thakare_9356978166.pdf" // 🔽 Replace with your actual resume file path
        ...
        <motion.div
          className="hidden sm:flex absolute bottom-12 right-8 md:right-12 flex-col gap-6 z-40"
          variants={itemVariants}
        >
          ...
          { icon: Mail, href: 'mailto:thakareyash74@gmail.com', label: 'Email' }].map(({ icon: Icon, href, label }) => (
            <a
              key={label}
              href={href}
              className="group text-slate-400 hover:text-orange-400 transition-colors duration-300"
              aria-label={label}
            >
